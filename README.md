...
All 9 unit tests cover deterministic rule checkers, native VLAN mismatches, interface admin down states, DHCP pool exhaustion, and strict Pydantic AI schema validations.
